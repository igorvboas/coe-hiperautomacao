-- =============================================================================
-- 0018_seed_gsmm_opportunities.sql — Tenant GSMM + admin + 10 oportunidades (levantamento)
-- =============================================================================
...
--     Após a 0017 o trigger é "convite-first": sem convite pendente ele cai no
--     fallback raw_app_meta_data->>'tenant_id' (setável só por service_role / SQL),
--     exatamente o que este seed faz — igual a 0002/0013.
...
--
-- Pré-requisitos: 0001..0017 aplicadas (schema v0.2 completo + 0017 allowlist).
--
...
--    Acme 22222222, Unidasul 55551da5).
-- -----------------------------------------------------------------------------
...
-- =============================================================================
-- FIM 0018 — GSMM: tenant + admin (tenant_admin) + 10 oportunidades (placeholder).
-- =============================================================================
