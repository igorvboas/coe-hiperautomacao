...
// Layout espelha `renderScoreTab` do mockup (_giba:1125-1141): total (gradiente)
// NO TOPO + os 5 fatores como cards, FTE em largura total. Os pesos abaixo
// replicam LITERALMENTE calcScore (SCORE-04, parity-tested) só para detalhar a
// contribuição de cada fator. O TOTAL prefere `o.score` da view (DB-authoritative);
// calcScore serve de verificação de paridade da fórmula.
  ...
  return (
    <div className="px-5 py-5">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        ...
        <div className="lg:col-span-2 rounded-xl bg-gradient-to-br from-pril to-pri text-white text-center px-4 py-4">
          <div className="text-[12px] text-white/70 mb-1">Score Total (máx 100)</div>
