...
> **Esta é a fronteira humana write-only (CLAUDE.md):** o agente NÃO aplica a migration. Após aplicar no SQL Editor (incluindo a segunda execução de idempotência) e rodar as 7 verificações acima (incluindo os 4 smoke tests do trigger e o smoke do teste negativo), **cole o resultado** para fechar este checkpoint.
